...
def generate_meta_info_div2k():
    ...
    gt_folder = '/data0/xtkong/Reflash-Dropout-github/dataset/DIV2K/DIV2K_train_HR_sub'
    meta_info_txt = '/data0/xtkong/Reflash-Dropout-github/dataset/DIV2K/meta_info_DIV2K800sub_GT.txt'
